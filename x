...
local function getMousePosition()
    -- Use WorldToViewportPoint to calculate position based on camera's perspective
    local screenPos = Camera:WorldToViewportPoint(TargetPlayer.Character.HumanoidRootPart.Position)
                        ...
                        if tool and tool:IsA("Tool") then
                            if not isIgnoringKnife() then
                                ...
                                if shootFunction and shootFunction:IsA("RemoteEvent") then
                                    ...
                                    local mouseX, mouseY = getMousePosition() -- Get the new mouse position based on predicted target position
